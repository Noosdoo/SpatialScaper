...
RIR_DIR = (
    "/scratch/ci411/rirs/spatialscaper_RIRs"  # Directory containing Room Impulse Response (RIR) files
)
...
OUTPUT_DIR = "/scratch/ci411/SELD/seld_datasets/SSBaseline_revert"  # Directory to store the generated soundscapes
REF_DB = (
    -65
