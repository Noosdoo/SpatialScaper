...
density = [1,5,10,20,30,45,60,90][int(sys.argv[1])//9]
...
RIR_DIR = (
    f"/scratch/ci411/rirs/downsampled_rirs/d_{density}"  # Directory containing Room Impulse Response (RIR) files
)
...
conf = conf_list[int(sys.argv[1])%9]
print(f"Density: {density}, Conf: {conf}")
