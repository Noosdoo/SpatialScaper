...
sys.path.append("/home/ci411/HARP")
sys.path.append("/home/ci411/SpatialScaper")

from Generate import get_material,  get_random_dimensions
from SphericalHarmonic import generate_hoa_array, SphericalHarmonicDirectivity

from spatialscaper.sofa_utils import create_srir_sofa

OUTPUT_DIR = "/scratch/ci411/rirs/harp_RIRs"
os.makedirs(OUTPUT_DIR, exist_ok=True)

ROOM_NAMES = [
    "bomb_shelter_foa", "gym_foa",
    "pb132_foa", "pc226_foa", "sa203_foa",
...
def generate_room(room_name):
    ...
    sofa_mic_pos = np.array([[0.0, 0.0, 1.2] for _ in range(rirs.shape[0])])
...
generate_room(ROOM_NAMES[int(sys.argv[1])])
